...
EXPERIMENT="tune_methods_glue_roberta"
...
# - constant lr scheduler in order not to mess up tuning
# - num_train_epochs is 0.5 for big datasets, 3 for small datasets (mnli vs. mrpc)
cmd=(
  ${RUN_CMD} \
